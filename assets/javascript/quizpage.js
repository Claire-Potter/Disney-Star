 ...
 */
 ...
 function getNewQuestion() {
   ...
   for (let i = 0; i < optionLen; i++) {
     // random option.
     const optonIndex = availableOptions[Math.floor(Math.random() 
   ...
   /** 
    * @function myTimer() is utilised below to set a 45 second count per
    *  question. This will update the timer div with the countdown. 
  ...
  * // array. Solution to add audio found on 
  ...
  * user selects an option. Created as per the WebShala tutorial 
  * and adapted by me.
  */
  ...
  *  whether the answer is correct or wrong (upateAnswerIndocator). This is
 ...
 /**
  * @function quizResult calls add the innerHTML to the results page to 
